...
class Xicro{
    public:
        ...
        // gen struct
        // gen public pub void        void publish_raw_accel();
        void publish_raw_gyro();
        void publish_button_1();
        void publish_button_2();
        void publish_button_3();
