...
// gen publish voidvoid Xicro::publish_raw_accel(){
    _crc=0;    _Sendstart();
    _SendSignature(1,4);
    _SendIdTopic(1);
    _SendFloat32((float*)&Publisher_raw_accel.message.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_raw_accel.message.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_raw_accel.message.z,1);
    _Sendstop();
    _Sendcrc();}
void Xicro::publish_raw_gyro(){
    _crc=0;    _Sendstart();
    _SendSignature(1,4);
    _SendIdTopic(2);
    _SendFloat32((float*)&Publisher_raw_gyro.message.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_raw_gyro.message.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_raw_gyro.message.z,1);
    _Sendstop();
    _Sendcrc();}
void Xicro::publish_button_1(){
    _crc=0;    _Sendstart();
    _SendSignature(1,4);
    _SendIdTopic(3);
    _SendBool((bool*)Publisher_button_1.message.data,1,0);
// auto by 1 bool
    _Sendcrc();}
void Xicro::publish_button_2(){
    _crc=0;    _Sendstart();
    _SendSignature(1,4);
    _SendIdTopic(4);
    _SendBool((bool*)Publisher_button_2.message.data,1,0);
// auto by 1 bool
    _Sendcrc();}
void Xicro::publish_button_3(){
    _crc=0;    _Sendstart();
    _SendSignature(1,4);
    _SendIdTopic(5);
    _SendBool((bool*)Publisher_button_3.message.data,1,0);
// auto by 1 bool
    _Sendcrc();}
